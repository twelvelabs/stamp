...
func (x *ConflictConfig) AppendText(b []byte) ([]byte, error) {
...
//
// Implementations must not retain b, nor mutate any bytes within b[:len(b)].
func (x *MatchSource) AppendText(b []byte) ([]byte, error) {
	return append(b, x.String()...), nil
}
...
//
// Implementations must not retain b, nor mutate any bytes within b[:len(b)].
func (x *MissingConfig) AppendText(b []byte) ([]byte, error) {
	return append(b, x.String()...), nil
}
...
//
// Implementations must not retain b, nor mutate any bytes within b[:len(b)].
func (x *VisibilityType) AppendText(b []byte) ([]byte, error) {
	return append(b, x.String()...), nil
}
